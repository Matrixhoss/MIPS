    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        for (int i = 0; i < Constants.RFormat.length; i++) {
            if (jList1.getSelectedValue().equals(Constants.RFormat[i])) {
                if (jTextField6.getText().isEmpty()) {
                    Ins = jList1.getSelectedValue() + " " + jList2.getSelectedValue() + "," + jList3.getSelectedValue() + "," + jList4.getSelectedValue();
                } else {
                    Ins = jTextField6.getText() + ":" + jList1.getSelectedValue() + " " + jList2.getSelectedValue() + "," + jList3.getSelectedValue() + "," + jList4.getSelectedValue();
                }
            }
        }
        for (int i = 0; i < Constants.JFormat.length; i++) {
            if (jList1.getSelectedValue().equals(Constants.JFormat[i])) {
                if (jTextField6.getText().isEmpty()) {
                    Ins =  jList1.getSelectedValue() + " " +jTextField7.getText();
                } else {
                    Ins = jTextField6.getText() + ":" + jList1.getSelectedValue() + " " +jTextField7.getText();
                }
            }
        }
        ...
        for (int i = 0; i < Constants.IFormat.length; i++) {
            if (jList1.getSelectedValue().equals(Constants.IFormat[i])) {
                if (jList1.getSelectedValue().equals("lw") ||jList1.getSelectedValue().equals("sw")) {
                    if (jTextField6.getText().isEmpty()) {
                    Ins =  jList1.getSelectedValue() + " " +jList2.getSelectedValue()+","+jTextField1.getText()+"("+jList3.getSelectedValue()+")";
                } else {
                    Ins = jTextField6.getText() + ":" + jList1.getSelectedValue() + " " +jList2.getSelectedValue()+","+jTextField1.getText()+"("+jList3.getSelectedValue()+")";
                }
                }
                ...
                if (jTextField6.getText().isEmpty()) {
                    Ins = jList1.getSelectedValue() + " " + jList2.getSelectedValue() + "," + jList3.getSelectedValue() + "," + jTextField1;
                } else {
                    Ins = jTextField6.getText() + ":" + jList1.getSelectedValue() + " " + jList2.getSelectedValue() + "," + jList3.getSelectedValue() + "," + jTextField1;
                }
